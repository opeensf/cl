...
const lotteryConfigs: Record<LotteryMode, LotteryConfig> = {
  senior: {
    ...
    colors: ['#EAB308', '#EAB308', '#22C55E', '#3B82F6', '#8B5CF6', '#8B5CF6']
  },
  aggressive: {
    name: '激进版',
    multipliers: [-1, -0.5, 0, 1, 3, 4],
    colors: ['#DC2626', '#EF4444', '#F97316', '#22C55E', '#3B82F6', '#8B5CF6']
  }
};
      ...
      <div className="p-4 max-w-md mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="mt-3 p-3 bg-gray-50 rounded-lg">
            <p className="text-sm text-gray-600 mb-2">倍数范围:</p>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={isSpinning}
                className={cn(
                  'flex items-center gap-2 px-4 py-3 border border-gray-300 text-gray-700 rounded-lg transition-colors',
                  isSpinning
