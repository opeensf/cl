...
const chanceEvents: ChanceEvent[] = [
  ...
  },
  {
    ...
    description: '暑期旅游热潮，住宿业火爆，旅游教育课程也受欢迎',
    effects: [
      { stockType: 'property', change: 1 },
      { stockType: 'education', change: 1 }
    ]
        ...
        {showResult && currentEvent && (
          <div className="bg-white rounded-xl p-6 shadow-sm animate-fade-in">
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-gray-700">股票价格变化：</h4>
              {currentEvent.effects.map((effect, index) => {
                const stockName = effect.stockType === 'property' ? '房产股' : '教育股';
