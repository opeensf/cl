...
import { TrendingUp, Users, Dice6, ArrowUp, ArrowDown, BarChart3, RotateCcw, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-md mx-auto space-y-6">
        ...
        {/* 玩家排行 */}
        <div className="bg-white rounded-xl p-4 shadow-sm">
          <h2 className="text-lg font-semibold mb-4">股票资产排行</h2>
          <div className="space-y-3">
            {playerRanking.map((player, index) => (
              <div key={player.id} className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">¥{player.totalValue.toFixed(2)}</p>
                </div>
              </div>
            ))}
          </div>
